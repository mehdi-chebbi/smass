...
async function seed() {
  ...
  const statistics = [
    {
      label: "Aquifer Area",
      labelFr: "Superficie de l'Aquifère",
      value: "350,000",
      unit: "km²",
      order: 0,
    },
