...
const keyActivities = [
  {
    title: 'Groundwater Monitoring Network',
    description: 'Installation and maintenance of monitoring wells across the country to track aquifer levels and water quality.',
  },
  {
    title: 'Community Water Access Programs',
    description: 'Developing sustainable water access solutions for rural communities dependent on groundwater resources.',
  },
  {
    title: 'Capacity Building Initiatives',
    description: 'Training local water management professionals in modern groundwater assessment techniques.',
  },
  {
    title: 'Climate Adaptation Pilots',
    description: 'Implementing pilot projects for groundwater-based climate adaptation solutions.',
  },
];
...
export default function GambiaPage() {
  ...
  return (
    <PageLayout
      titleKey="water.countries.gambia.name"
      subtitleKey="water.countries.gambia.description"
      backHref="/water"
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex items-center gap-2 text-smas-charcoal/70">
                  ...
                  <span>Banjul (Capital)</span>
                </div>
                <div className="flex items-center gap-2 text-smas-charcoal/70">
                  <Users className="w-4 h-4" />
                  <span>~2.5 million population</span>
                </div>
                <div className="flex items-center gap-2 text-smas-charcoal/70">
                  <Droplets className="w-4 h-4" />
                  <span>SMAS coverage: Entire country</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              ...
              <ul className="space-y-2 text-sm text-white/90">
                <li className="flex items-start gap-2">
                  ...
                  <span>Full national coverage of SMAS monitoring network</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 bg-smas-aqua rounded-full mt-2 flex-shrink-0" />
                  <span>Integration with Gambia River Basin initiatives</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 bg-smas-aqua rounded-full mt-2 flex-shrink-0" />
                  <span>Active community engagement programs</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 bg-smas-aqua rounded-full mt-2 flex-shrink-0" />
                  <span>Transboundary cooperation with Senegal</span>
                </li>
              </ul>
            </CardContent>
          </Card>
