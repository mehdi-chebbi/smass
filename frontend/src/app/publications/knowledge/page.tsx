...
export default function Page() {
  ...
  useEffect(() => {
    fetch('/api/publications?type=KNOWLEDGE&limit=50')
      .then(r => r.json()).then(d => { setItems(d.publications || []); setLoading(false); }).catch(() => setLoading(false));
  }, []);
  return (
    <PageLayout titleKey="publications.knowledge.title" subtitleKey="publications.knowledge.description" backHref="/publications" backLabelKey="publications.label">
